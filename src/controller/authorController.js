...
const loginAuthor = async function (req, res) {
    try {
        ...
        //validating password with regex , password should have atleast one uppercase one lower case and one special character and it ranges between 6 to 20 character
        ...
        let token = jwt.sign(                    //making the token
            {
                ...
                project: "blogging-Site"          // payload 
            },
            'author-blog'      // secret key
        );
